...
public class LibrarySlidingTabStrip extends HorizontalScrollView {
	...
	private Typeface tabTypeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/Roboto-Regular.ttf");
	...
	public LibrarySlidingTabStrip(Context context) {
		this(context, null);
	}

	public LibrarySlidingTabStrip(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public LibrarySlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
