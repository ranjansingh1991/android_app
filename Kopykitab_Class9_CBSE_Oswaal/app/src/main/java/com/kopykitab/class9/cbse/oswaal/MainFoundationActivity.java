...
public abstract class MainFoundationActivity extends AppCompatActivity {
    ...
    private class RegisterIntoGCM extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            String regId = null;
            try {
                GoogleCloudMessaging gcmObj = GoogleCloudMessaging.getInstance(MainFoundationActivity.this);
            ...
            if (regId != null && !regId.isEmpty()) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        postParams.add(new BasicNameValuePair("customer_id", customerId));
                        postParams.add(new BasicNameValuePair("app_id", AppSettings.getInstance(MainFoundationActivity.this).get("APP_ID")));
                        postParams.add(new BasicNameValuePair("gcm_reg_id", regId));
                        ...
                        try {
                            ...
                            Log.i("GCM Store Details", EntityUtils.toString(httpEntity));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    protected class GetLatestVersion extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                if (doc.getElementsByAttributeValue("itemprop", "softwareVersion").first().text() != null) {
