...
import com.kopykitab.class9.cbse.oswaal.components.SyncDataFromAPI;
...
public class MenuListAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (groupPosition > 0) {
            ...
            com.kopykitab.class9.cbse.oswaal.components.TextView userName = (com.kopykitab.class9.cbse.oswaal.components.TextView) convertView.findViewById(R.id.menu_list_option_text);
