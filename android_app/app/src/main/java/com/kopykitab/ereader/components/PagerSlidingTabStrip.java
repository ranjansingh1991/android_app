...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFFFF8F00;
	...
	private int tabTextColor = Color.parseColor("#787878");
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if(pager.getCurrentItem() == i)	{
					tab.setTextColor(getContext().getResources().getColor(R.color.action_bar_background));
				} else	{
