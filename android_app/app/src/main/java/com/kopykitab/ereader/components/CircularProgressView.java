...
public class CircularProgressView extends View {
    ...
    private Paint paint, unfinishedPaint;
    private int size = 0;
    ...
    private int thickness, color, unfinishedColor, animDuration, animSwoopDuration, animSyncDuration, animSteps;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        unfinishedColor = resources.getColor(R.color.cpv_default_unfinished_color);
    ...
    private void updatePaint() {
        ...
        unfinishedPaint.setStrokeWidth((thickness * 0.6f));
        unfinishedPaint.setStrokeCap(Paint.Cap.BUTT);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isIndeterminate) {
            ...
            canvas.drawArc(bounds, startAngle + sweepAngle, 360 - sweepAngle, false, unfinishedPaint);
        } else
    ...
    /**
     * Sets the unfinished color of the progress bar.
     *
     * @param color the unfinished color of the progress bar
     */
